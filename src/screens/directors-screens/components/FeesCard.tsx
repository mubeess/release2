...
import useInvoiceSettingsTrack from "../hooks/useInvoiceSettingsTrack";
interface IProps {
  termId: string;
  activeLevels: ClassLevelDto[];
}
export default function FeesCard({ termId, activeLevels }: IProps) {
  const {
    configured,
    totalLevels,
    levelConfigurations,
  ...
  return (
    <View style={styles.container}>
      <View style={styles.head}>
        <Text h2>Fees/ Invoice Configured</Text>
        <Text style={{ color: lightTheme.colors.PrimaryGrey }}>
          Invoice creation and application for all class levels
        </Text>
      </View>
